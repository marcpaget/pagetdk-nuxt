...
function polyfillAsVueUseHead(head) {
    ...
    polyfilled.addReactiveEntry = (input, options) => {
        ...
        if (typeof api !== 'undefined') return api.dispose
        return () => {}
    }
...
const navigateTo = (to, options) => {
    ...
    const router = useRouter()
    {
        ...
        if (nuxtApp.ssrContext && nuxtApp.ssrContext.event) {
            ...
            const redirectLocation = isExternal
                ? toPath
                : joinURL(useRuntimeConfig().app.baseURL, router.resolve(to).fullPath || '/')
            return nuxtApp
                .callHook('app:redirected')
                .then(() =>
                    sendRedirect(
...
const router_P0yWDWTO4H = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
            ...
            return () => {
                ...
                return props.custom
                    ? (_a = slots.default) == null
                        ? void 0
                        : _a.call(slots, { href: props.to, navigate, route: route2 })
                    : h(
                          'a',
                          {
                              href: props.to,
...
const _plugins = [components_plugin_KR1HBZs4kY, unhead_3Bi0E2Ktsf, vueuse_head_polyfill_I556vu5uhL, router_P0yWDWTO4H]
const welcome_vue_vue_type_style_index_0_scoped_a47dbf95_lang = ''
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [['__scopeId', 'data-v-a47dbf95']])
const _sfc_main = {
    __name: 'nuxt-root',
    __ssrInlineRender: true,
    setup(__props) {
        const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() =>
            import('./_nuxt/error-component-07e27227.js').then((r) => r.default || r)
        )
        const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() =>
            import('./_nuxt/island-renderer-98b9b2e7.js').then((r) => r.default || r)
        )
        const nuxtApp = useNuxtApp()
            ...
            ssrRenderSuspense(_push, {
                default: () => {
                    if (unref(error)) {
                        ...
                        _push(
                            ssrRenderComponent(unref(IslandRenderer), { context: unref(islandContext) }, null, _parent)
                        )
                    } else {
