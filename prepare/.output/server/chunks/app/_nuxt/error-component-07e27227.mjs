...
const _sfc_main = {
    ...
    setup(__props) {
        ...
        const statusMessage =
            (_a = error.statusMessage) != null ? _a : is404 ? 'Page Not Found' : 'Internal Server Error'
        const description = error.message || error.toString()
        const stack = void 0
        const _Error404 = /* @__PURE__ */ defineAsyncComponent(() =>
            import('./error-404-e5d48cb2.mjs').then((r) => r.default || r)
        )
        const _Error = /* @__PURE__ */ defineAsyncComponent(() =>
            import('./error-500-2a11181e.mjs').then((r) => r.default || r)
        )
...
//# sourceMappingURL=error-component-07e27227.mjs.map
