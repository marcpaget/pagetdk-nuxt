...
export default defineNuxtConfig({
  modules: ['@nuxt/content', // '@nuxtjs/tailwindcss', disabled because of nuxt-ui
    // '@nuxtjs/prismic',
    '@formkit/nuxt', '@vueuse/nuxt', '@nuxtjs/supabase', // '@nuxtjs/color-mode', disabled because of nuxt-ui
    // 'nuxt-icon', disabled because of nuxt-ui
    // '@nuxtjs/partytown',
    'unplugin-icons/nuxt', // '@inkline/nuxt',
    // 'nuxt-umami',
    '@sidebase/nuxt-session', // '@nuxtjs/vuetify',
    '@pinia/nuxt', 'nuxt-viewport', 'nuxt-swiper', // '@nuxt/image-edge',
    'nuxt-headlessui', '@dargmuesli/nuxt-cookie-control', // 'nuxt-logrocket',
    '@nuxt/devtools', // 'nuxt-bugsnag',
    // '@nuxtjs/i18n',
    // '@varlet/nuxt',
    '@hypernym/nuxt-anime', // 'nuxt-purgecss',
    '@nuxtjs/strapi', '@tresjs/nuxt', // 'nuxt-vuefire',
    'vue3-carousel-nuxt', 'nuxt-api-party', '@morev/vue-transitions/nuxt', 'nuxt-vercel-analytics', '@hypernym/nuxt-gsap', 'nuxt-anchorscroll', 'nuxt-gtag', // 'nuxt-aos',
    '@nuxtjs/cloudinary', 'nuxt-primevue', '@nuxt/image', '@nuxtjs/seo', 'nuxt-particles', '@oku-ui/motion-nuxt', '@nuxt/ui', '@nuxt/eslint'],
  supabase: {
    redirect: false,
  ...
  build: {
    transpile:
            process.env.NODE_ENV === 'production' ? ['naive-ui', 'vueuc', '@css-render/vue3-ssr', '@juggle/resize-observer', 'vuetify', 'primevue'] : ['@juggle/resize-observer', 'vuetify', 'primevue'],
  },
