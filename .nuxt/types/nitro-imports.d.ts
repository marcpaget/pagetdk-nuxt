declare global {
  ...
  const getSiteIndexable: typeof import('../../node_modules/nuxt-simple-robots/dist/runtime/nitro/composables')['getSiteIndexable']
...
export { getPathRobotConfig, getSiteIndexable } from '#internal/nuxt-simple-robots';
