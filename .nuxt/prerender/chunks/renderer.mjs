...
import { eventHandler, setResponseStatus, getQuery, createError, readBody } from 'file:///Users/marcpaget/Kodeprojekter/pagetdk-nuxt/node_modules/h3/dist/index.mjs';
...
import { b as useNitroApp, a as useRuntimeConfig, g as getRouteRules } from './nitro/nitro-prerenderer.mjs';
import { joinURL } from 'file:///Users/marcpaget/Kodeprojekter/pagetdk-nuxt/node_modules/ufo/dist/index.mjs';
...
const ISLAND_CACHE = /* @__PURE__ */ new Map() ;
...
const renderer = defineRenderHandler(async (event) => {
  ...
  if (islandContext && ISLAND_CACHE.has(event.node.req.url)) {
  ...
  if (islandContext) {
    ...
    {
      ISLAND_CACHE.set(`/__nuxt_island/${islandContext.name}:${islandContext.id}`, response2);
    }
    return response2;
  }
  const response = {
