 ...
 */
.breadcrumb.-light {
  --breadcrumb--color: var(--color-dark);
  --breadcrumb--link--color: var(--color-primary);
  --breadcrumb--active--color: var(--color-gray-500);
}
.breadcrumb.-dark {
...
.input-wrapper .input .input-clear {
...
.input-wrapper .input .input-clear:hover, .input-wrapper .input .input-clear:focus {
...
.input-wrapper .input .input-clear:active {
  background: var(--input--clear--active--background, var(--input--clear--background));
}
.input-wrapper .input .input-clear::before {
...
.input-wrapper.-light {
  ...
  --input--clear--background: var(--input--light--clear--background, transparent);
  --input--clear--hover--background: var(
      --input--light--clear--hover--background,
      var(--color-light)
  );
  --input--clear--active--background: var(
      --input--light--clear--background--active,
      var(--color-light-shade-50)
  );
  --input--clear--color: var(--input--light--clear--color, var(--contrast-text-color-white));
...
.input-wrapper.-dark {
  ...
  --input--clear--background: var(--input--dark--clear--background, transparent);
  --input--clear--hover--background: var(
      --input--dark--clear--hover--background,
      var(--color-dark-tint-50)
  );
  --input--clear--active--background: var(
      --input--dark--clear--background--active,
      var(--color-dark-tint-100)
  );
  --input--clear--color: var(--input--dark--clear--color, var(--contrast-text-color-dark));
...
.input-wrapper.-sm {
  ...
  --input--clear--size: calc(1.2rem * var(--size-multiplier-sm));
}
.input-wrapper.-md {
  --input--border-top-left-radius: var(
  ...
  --input--clear--size: calc(1.2rem * var(--size-multiplier-md));
}
.input-wrapper.-lg {
  --input--border-top-left-radius: var(
  ...
  --input--clear--size: calc(1.2rem * var(--size-multiplier-lg));
}
...
.select-wrapper .input-wrapper * + .select-caret {
...
.select .select-option.-disabled {
  pointer-events: none;
  cursor: default;
  color: var(--select--option--disabled--color, var(--select--color));
