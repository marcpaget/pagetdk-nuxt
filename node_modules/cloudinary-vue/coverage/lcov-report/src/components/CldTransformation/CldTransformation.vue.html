...
<head>
    <title>Code coverage report for src/components/CldTransformation/CldTransformation.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/CldTransformation</a> CldTransformation.vue</h1>
        <div class='clearfix'>
...
export default {
  ...
  created() {
<span class="missing-if-branch" title="else path not taken" >E</span>    if (this.registerTransformation) {
<span class="branch-1 cbranch-no" title="branch not covered" >      this.registerTransformation(this.$attrs || {});</span>
    }
  },
  render() {
    return null;
