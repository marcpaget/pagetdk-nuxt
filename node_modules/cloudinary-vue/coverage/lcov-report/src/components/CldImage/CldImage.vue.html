...
<head>
    <title>Code coverage report for src/components/CldImage/CldImage.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/CldImage</a> CldImage.vue</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >      const placeholder = responsiveModeNoSize ? '' : this.cloudinary.url(this.publicId, placeholderOptions)</span>
