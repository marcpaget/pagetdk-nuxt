...
<head>
    <title>Code coverage report for src/components/CldVideo/CldVideo.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/CldVideo</a> CldVideo.vue</h1>
        <div class='clearfix'>
...
<span class="branch-1 cbranch-no" title="branch not covered" >          transformation: this.extraTransformations || [],</span>
...
<span class="missing-if-branch" title="else path not taken" >E</span>      if (this.poster &amp;&amp; this.poster.publicId) {
