...
<head>
    <title>Code coverage report for src/mixins/lazy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/mixins</a> lazy.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { watchElementVisibility } from "../helpers/visibility"
import {
  LAZY_LOADING,
  ...
  methods: {
    updateVisibilityObservation() {
      if (!this.hasLazyLoading) {
        this.visible = true
        this.cancelVisibilityListener &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.cancelVisibilityListener()</span>
        return
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (this.cancelVisibilityListener) {</span>
<span class="cstat-no" title="statement not covered" >      this.cancelVisibilityListener();</span>
    }
  }
};
&nbsp;</pre></td></tr></table></pre>
