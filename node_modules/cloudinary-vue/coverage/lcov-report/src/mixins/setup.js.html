...
<head>
    <title>Code coverage report for src/mixins/setup.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/mixins</a> setup.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Cloudinary, Util } from 'cloudinary-core';
/**
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (extraConfigs) {
