...
<head>
    <title>Code coverage report for src/helpers/findComponent.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/helpers</a> findComponent.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">28x</span></td><td class="text"><pre class="prettyprint lang-js">import { COMPONENTS } from '../constants'
&nbsp;
/**
 * 
...
&nbsp;
export const getCldPoster = (children = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> =&gt; {
...
&nbsp;
export const isCldPoster = (component) =&gt; component.componentOptions?.Ctor?.extendOptions?.name === COMPONENTS.CldPoster </pre></td></tr></table></pre>
