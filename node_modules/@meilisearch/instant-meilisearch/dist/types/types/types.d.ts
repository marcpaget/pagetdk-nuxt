...
import type { MultiSearchQuery as MeiliSearchMultiSearchParams, MultiSearchResult } from 'meilisearch';
...
export type { Filter, FacetDistribution, MeiliSearch, FacetStats as MeiliFacetStats, MultiSearchQuery as MeiliSearchMultiSearchParams, } from 'meilisearch';
...
export type MeilisearchMultiSearchResult<T = Record<string, any>> = MultiSearchResult<T> & {
...
export type AlgoliaFacetStats = Record<string, {
    /**
