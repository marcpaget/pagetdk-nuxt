...
options: {
type: PropType<string[] | number[] | FormKitOptionsList | Record<string | number, string> | undefined>;
};
help: {
type: PropType<string | undefined>;
};
...
onSubmit?: ((_data: FormKitGroupValue, _node: FormKitNode) => any) | undefined;
onSubmitRaw?: ((_event: Event, _node: FormKitNode) => any) | undefined;
}, {
