...
function getPaths(obj, paths = [], ...parents) {
    ...
    for (const key in obj) {
        ...
        const value = obj[key];
        if (utils.isPojo(value) || Array.isArray(value)) {
...
function useInput(props, context, options = {}) {
    ...
    node.on('modelUpdated', () => {
        ...
        if (isVModeled && node.context) {
            ...
            if (utils.isObject(newValue) && useRaw(props.modelValue) !== newValue) {
    ...
    if (isVModeled) {
        watchVerbose(vue.toRef(props, 'modelValue'), (path, value) => {
            ...
            if (utils.isObject(rawValue) && mutex.has(rawValue)) {
