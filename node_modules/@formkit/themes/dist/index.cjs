...
function loadTheme(theme) {
    ...
    if (theme &&
        ...
        const formkitVersion = core.FORMKIT_VERSION.startsWith('__') ? 'latest' : core.FORMKIT_VERSION;
...
exports.createIconHandler = createIconHandler;
exports.createThemePlugin = createThemePlugin;
