          ...
          if (isSelfClosingTag) {
            ...
            if (children.length > 1) {
              ...
              if (vfor && children[0].type === ELEMENT_NODE) {
                ...
                s.overwrite(loc2[0].start, loc2[0].end, `<${name} v-for="${vfor[0]} in ${vfor[1]}" ${attrs} ${isSelfClosingTag2 ? "/" : ""}>`);
              }
...
const version = "3.5.2-28088648.b7547c3c";
  ...
  for (const dir of pathsToWatch) {
    ...
    watcher.on("all", (event, path) => {
      ...
      if (event === "addDir" && path !== dir && !ignoredDirs.has(path) && !(path in watchers) && !isIgnored(path)) {
        ...
        watchers[path].on("all", (event2, path2) => nuxt.callHook("builder:watch", event2, normalize(path2)));
