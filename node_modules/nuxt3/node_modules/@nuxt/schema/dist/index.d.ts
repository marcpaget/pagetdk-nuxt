...
import { ModuleOptions as ModuleOptions$1 } from '@nuxt/telemetry';
 ...
 */
  ...
  */
   ...
   * 
  */
  asyncTransforms: unctx.TransformerOptions,
 },
 ...
 */
  ...
  * 
  * @default ["**\/*.stories.{js,ts,jsx,tsx}","**\/*.{spec,test}.{js,ts,jsx,tsx}","**\/*.d.ts",".output",".git","/<rootDir>/.nuxt/analyze","/<rootDir>/.nuxt","**\/-*.*"]
 */
 ignore: Array<string>,
...
type Overrideable<T extends Record<string, any>, Path extends string = ''> = {
    [K in keyof T]?: K extends string ? T[K] extends Record<string, any> ? RuntimeValue<Overrideable<T[K], `${Path}_${UpperSnakeCase<K>}`>, `You can override this value at runtime with NUXT${Path}_${UpperSnakeCase<K>}`> : RuntimeValue<T[K], `You can override this value at runtime with NUXT${Path}_${UpperSnakeCase<K>}`> : K extends number ? T[K] : never;
};
