...
import type { CheckIn, Event, EventHint, MonitorConfig, Severity, SeverityLevel } from '@sentry/types';
...
export declare class NodeClient extends BaseClient<NodeClientOptions> {
     ...
     */
    captureCheckIn(checkIn: CheckIn, monitorConfig?: MonitorConfig): void;
    /**
     * @inheritDoc
     */
