...
import { defineHeadPlugin, resolveTitleTemplate, hashTag, hashCode, tagDedupeKey, HasElementTags, ValidHeadTags, asArray, TagConfigKeys, TagsWithInnerContent } from '@unhead/shared';
import 'node:fs';
import 'pathe';
