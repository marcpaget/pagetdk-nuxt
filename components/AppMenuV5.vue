<!-- <template>
    <div class="navbar bg-base-100">
        <div class="navbar-start">
            ...
            <nuxt-link class="btn-ghost btn font-permanentmarker text-3xl normal-case text-kaldi" to="/"
                >paget.dk</nuxt-link
            >
        </div>
    ...
    <div class="navbar bg-base-100">
        <div class="navbar-start">
            <div class="dropdown">
                ...
                <ul tabindex="0" class="menu-sm dropdown-content menu rounded-box mt-3 w-52 bg-base-100 p-2 shadow">
                    <li><a>Item 1</a></li>
                    <li>
                        <a>Projekter</a>
                        <ul class="p-2">
